...
#Stores the date and time in an array indexed by episodes
	datepisode[sumep[I]] = date[I];
	timepisode[sumep[I]] = time[I];
...
for(Istorm=0;Istorm < maxepisode; Istorm++)
{
M = Istorm + 1;
...
for(Istorm=0;Istorm < maxepisode;Istorm++)
{
#		print Istorm,timep[Istorm],Pepisode[Istorm]
